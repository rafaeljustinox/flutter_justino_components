...
class ModernLinearPercentIndicator extends StatefulWidget {
  ...
  ///padding to the MyLinearPercentIndicator
...
class _LinearPercentIndicatorState extends State<ModernLinearPercentIndicator>
  ...
  void _checkIfNeedCancelAnimation(ModernLinearPercentIndicator oldWidget) {
  ...
  @override
  void didUpdateWidget(ModernLinearPercentIndicator oldWidget) {
